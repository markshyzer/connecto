...
content = () => {
    if (this.props.content == 1) {
        ...
        return (
            <div>
                <p className='instructions'>Connect all the dots in the puzzle to win! Start with any dot, then move to any dot connected by a line. You can't visit a dot or use a line twice.</p>
                <img className="sample" src={example} />
                <p className='instructions'>Earn a trophy for every puzzle you complete. Check them out in your trophy room!</p>
            </div>
        )
    }
}
    ...
    render(){
        return(
            <div className='menuPage'>
                <div className='menuPageItem' id='0' onClick={this.props.selectMenu}><img className='menuPageIcon' src={leftArrow} /><p id='0'>MENU PAGE</p></div>
